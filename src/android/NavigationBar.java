...
public class NavigationBar extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args,CallbackContext callbackContext) throws JSONException {
        ...
        boolean hasPhysicallyButtons = KeyCharacterMap.deviceHasKey(KeyEvent.KEYCODE_BACK);

        if(hasPhysicallyButtons) {

            // if device has physical buttons, there is no need for hiding a navigation bar that doesn't exist
            return true;
        }
    ...
    private void _hideNavigationBar(){
        ...
        this._hideNavigationBar(activity);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    private void _hideNavigationBar(Activity activity){
